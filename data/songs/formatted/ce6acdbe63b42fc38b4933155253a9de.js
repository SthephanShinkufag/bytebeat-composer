...
128 +
	// Drums
	square(window.channels[0]) +
	// Bass
	saw(window.channels[1]) +
	// Chords 1/3
	square(window.channels[2]) +
	// Chords 2/3
	square(window.channels[3]) +
	// Chords 3/3
	square(window.channels[4]) +
	// Pad 1/4
	saw(window.channels[5]) +
	// Pad 2/4
	saw(window.channels[6]) +
	// Pad 3/4
	saw(window.channels[7]) +
	// Pad 4/4
	saw(window.channels[8]) +
	// Lead
	triangle(window.channels[9], 1) +
	// Lead echo
