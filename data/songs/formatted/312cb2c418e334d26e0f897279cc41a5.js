...
t > 490000 ? plinky_seq = [0.5, 0.6, 0.3, 0.4, 0.1, 0.15, 0.4, 0.15] :
plinky_seq = [0.35, 0.04, 0.2, 0.2, 0.45, 0.5, 0.4, 0.2],
t > 850000 ? key = 1 :
t > 750000 ? key = 2 :
t > 430000 ? key = 1 :
t > 365000 ? key = 2 :
...
(32 + random() * ((t * 0.0005 ^ 3) % 4) * mixer[1]) +

/* hihat [noise w/ shorter envelope] */
(32 + random() * ((t * 0.002 ^ 3) % 2) * mixer[2]) +
