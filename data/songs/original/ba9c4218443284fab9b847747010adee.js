...
chip(
[
parseInt(d[(t>>speed)%d.length].split("|")[0],16),
parseInt(d[(t>>speed)%d.length].split("|")[1],16),
parseInt(d[(t>>speed)%d.length].split("|")[2],16),
parseInt(d[(t>>speed)%d.length].split("|")[3],16)
],[],[]
);
