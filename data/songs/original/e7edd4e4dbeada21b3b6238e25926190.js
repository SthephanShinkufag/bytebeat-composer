...
insC=(mel=k1)=>rv(m(ins(mel),.975),16e3,.6,1.2,1,1)*dec(1,4,6e3),
...
kick=kk=(8e5/((ts*kseq[bt(kseq.length,12)]>>2)%2048))*2||0,
...
comp=cL=m(((insC()%192)|(sn&253)+m(bs2,.2)+10)+m((bs^((kk%184)^hh*6)|(bs2&72)|sn&253),.45),.955),

cR=m(((insC(k2)%191)|(sn&253)+m(bs2,.2)+10)+m((bs^((kk%183)^hh*6)|(bs2&71)|sn&255),.4),.96),

cM=[max(cL,-256),max(cR,-256)],
