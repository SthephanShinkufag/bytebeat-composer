...
const SETTINGS = {BPM:360,BPB:4,MPB:8,A4:440,VBS:50,D:300,SMOL: 1};

let SONG,OUTPUT,t,t1,sr,CHANNELS,maxChCount=3,chCount;
let snare = 0;
...
function THEHYPERSPHERE(T,SR){
	...
	WAVE('01',MSEQ('5C0C',1,50)).add(1-SONG.UNMOD.BEAT%1);
	DRUMS(' SSH',1,2).add(1);
	WAVE('01',MSEQ('',1,50)).add(2-SONG.UNMOD.BEAT*2%2);
