...
nd=(q*([a,a<<1,a,0,a,0,a,0,g>>1,g,g>>1,0,e>>1,0,c>>1,c][int(q*4)%16])/4)*z,	//BASS

kick = (tan(sin( 32/((((q*64)%32))) ))*(((((q*16)%8)<2.5) & (((q*16)%8)>0.2))*((2-(((q*16)%4)))*32))) *(((q*8)%8)<1),
snare = ((((((q*16)%16)>7.9) & (((q*16)%16)<8.75)) * (((q*(f>>2))&1)*80)) + (((random()*8)>>2)*(((28-(((q*64)%32)))/2.8) * (int(q*4)%4) ))/1.5),
hihat = (((q*64)%8<2)*(((random()*7)<<6)>>4))+((((q*64)%8)<1)*(((q*7040)%2)<<3)),

//output channels
(((kick+snare+hihat)/2)+
(((sin(na*4)<cos(q*4))*4.5)*((4-(((q*32)%4)))*1.3))+
(((tan(sin(nb*2.00)*1.5)/2.39)*(sin(nb*3.00)*3)*(cos(nb*1.013)*2)/2)*(((8-(((q*32)%8))*0.9)-3)/1.7)))/1.3+
