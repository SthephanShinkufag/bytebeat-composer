...
b = t / 441e3 * 16,
// A one-hot variable to tell which measure the song is in, used to play different things in different measures
m = 1 << ((b / 16) % 16),
...
99 + 27 * (
  // To sequence the parts, the "m&0b0000011100111111" and similar only plays the part during certain measures.
  // 1st measure is on the right

  // Kick drum. Beats appear as 1's in "0b10100110100001" starting from the right
  (m & 0b0000011100111111 && 0b10100110100001 & 1 << s % 16 ? z(q / (q / 241 + 2e-4)) + z(t / 140) / 2 : 0) +
  ...
  (m & 0b0010011011011000 ? w(s == 6 && i(b * 6 % 6) == 1 ? 85 : s == 14 && q < .25 ? 78 : 'SSSSSSSQOOONNOLJLLLLLNLJIIIGGG' [c](s), s == 5) : 0) +
