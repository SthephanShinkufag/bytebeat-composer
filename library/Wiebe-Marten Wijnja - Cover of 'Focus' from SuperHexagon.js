...
-> I wanted to learn more about procedural content genration.
  (Yep, although the output from this code is deterministic, it is procedural)

Features:
-> Speedup or slowdown as much as you want without losing quality
-> Play backwards!
-> When compressed, only 3452 bytes:
   1/1000th of the size of Focus as .mp3(actually a lossy format) which is +- 2.5 Megabytes.
...
SAMPLE_RATE = 44100,
t *= 44100 / SAMPLE_RATE,
// Enable this for sdrawkcab fun!
backwards = false,
// Change this value to increase or decrease speed. 1.055 is the speed the original Hexagonest has.
factor = 1.055,
// Song will increase its speed slightly while going on! :D
speedup = true,
...
// All envelopes are simple Decay envelopes.
// The numbers indicate the time it takes to go from full volume to 0.
...
base = (t >> 20 == 0) || (t >> 20 == 2) ? "F F  F  " :
  (t >> 20 == 1) ? "F F F F " :
  (t >> 20 == 3) ? "        " :
  (t >> 20 == 4) ? "F   F   F F F   " :
  "F F  F  ",
basee = (t >> 20 == 0) || (t >> 20 == 2) ? "20200200" :
  (t >> 20 == 1) ? "20202020" :
  (t >> 20 == 3) ? "00000000" :
...
// Different pattern length depending on place in song.
basemod = (t >> 18 == 15 ? 32 : (t >> 20 == 4) ? 16 : 8),

snaree = (t >> 20 == 3) ? "00008880" : (t >> 20 == 4) || (t >> 20 == 5) ? "00002000" : "00200020",
hihate = (t >> 20 == 2) ? "0000101010001000000001010100010000" :
