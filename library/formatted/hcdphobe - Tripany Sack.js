...
// The volume
volume = 60,
// Checks if the volume exceeds beyond 100 or less than 0 and if it does mute that
x = volume > 100 ? 0 : volume < 0 ? 0 : volume / 100,
// Some shortcuts
S = x => sin(x * PI / 128),
C = x => cos(x * PI / 128),
// The sample rate
...
x * (
	S(t1 + S(t1 / 2.002) * 128) * (-beat * 64 / 10 & 255) / 768 +
	d1 / 2 +
	S(1000 / (beat / 10 % 16 + .2)) * (-beat * 16 / 10 & 255) / 768 +
	S(a - C(a / 2) * 128 + S(a / 2) * 128) * S(a) * S(64 + beat / 120) / 9
);
