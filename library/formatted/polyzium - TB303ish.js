...
window.channels = t > 0 ? window.channels : [{
	...
	held: false,
	notes: [
		{ start: 0, end: bt - 4, note: G / 2 },
		{ start: bt, end: bt * 2 - 4, note: F / 2 },
		{ start: bt * 2, end: bt * 3 - 4, note: As / 4 },
		{ start: bt * 3, end: bt * 5, note: As / 4, target: Gs / 2 },
		{ start: bt * 5, end: bt * 6 - 4, note: As / 4 },
		{ start: bt * 6, end: bt * 7 - 4, note: As / 4 },
		{ start: bt * 7, end: bt * 8 - 4, note: F / 4 },
		{ start: bt * 8, end: bt * 9 - 4, note: Ds / 4 },
		{ start: bt * 9, end: bt * 10 - 4, note: As / 4 },
		{ start: bt * 10, end: bt * 13, note: As / 4, target: Fs / 2 },
		{ start: bt * 13, end: bt * 14 - 4, note: As / 4 },
		{ start: bt * 14, end: bt * 15 - 4, note: G / 2 },
		{ start: bt * 15, end: bt * 16 - 4, note: As / 4 }
	]
}],
...
window.channels.forEach(chan => {
	...
	chan.ndx = ndx;
	note = chan.notes[ndx];
	const inc = 1 / (note.end - note.start) / (SAMP_RATE / (BPM * 1.25));
...
ws(acid.lp24 * ampenv.process(), 10) / 2;
