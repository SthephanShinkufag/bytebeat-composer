...
f = x => {
  ...
  vol = x / 2e3 % 10;
  return sin(log(.5 + (x / 1e3) % 20) * 40) * 2 *
    e((x / 2) / 1e3, 1.5, .2) * sq(0) * (t > 7e6 ? 0 : 1) +
    sin(x + sin(x) * 1e9 * e((x) / 1.5e3, 3, .05)) * 1 *
    e((x) / 3e3, 4, 0.2) * sq(1) * (t > 7e6 ? 0 : 1) +
    sin(x + sin(x) * 1e9) * 1 *
    e((x) / .5e3 * ia(sin(x / 1e4) + 2), 3, .2) * sq(2) * (t > 7e6 ? 0 : 1) +
