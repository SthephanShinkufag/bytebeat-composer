...
((((sin(t / 15) + sin(t / 20)) / 7) + random()) *
  env(s / (7 / 4) * (1 + sin(s / 80) < 1.9 ? 1 : 7), 1 * (1 + sin(s / 40) < 1.5 ? 1 : 0.4), 0.8) * 3) * mixer[1] +
...
// waveshaping chords
(sin(Math.E + abs(sin(s / 100) * 4) ** (s * chord_seq[chord_index][0] % 2)) * 1 * env((s / 4), 0.5, 0.2) * 0.5 +
  sin(Math.E + abs(sin(s / 100) * 4) ** (s * chord_seq[chord_index][1] % 2)) * 1 * env((s / 4), 0.5, 0.2) * 0.5 +
  sin(Math.E + abs(sin(s / 100) * 4) ** (s * chord_seq[chord_index][2] % 2)) * 1 * env((s / 4), 0.5, 0.2) * 0.5 +
  sin(Math.E + abs(sin(s / 100) * 4) ** (s * chord_seq[chord_index][3] % 2)) * 1 * env((s / 4), 0.5, 0.2) * 0.5) * mixer[3] +
