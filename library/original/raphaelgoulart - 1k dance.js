z=40.7,b=t/2250,r=floor(b),y=r%16,
...
x=floor(r/4)%4,d=[12,12,10.67,12][x],g=[9.52,9.52,8,8.96][x],h=[8,7.12,6.72,7.52][x],v=(b*2%4)*1.25,
w=floor(y/12),u=floor(r/16)%4,
j=[[19.04,17.92],[14.24,9.52],[10.64,12],[8,0]],
sin(t*(1/(z))+sin(t*(1.125)/z)*7*(1-b*2%4>0?1-b*2%4:0))*(40-b*15%30)+40+
...
(b<192?0:sin(t*(j[u][w]/z)+sin(t*(j[u][w]*2)/z)*4*(y<2||y>=12&y<14?1-b/2%1:0))*(5.3-y/3%4)+5.3)